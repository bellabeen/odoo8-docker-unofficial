...
report_sxw.report_sxw('report.rml.dealer.sale.order.pelunasan.dso', 'dealer.sale.order', 'addons/dealer_sale_order/report/dealer_sale_order_pelunasan_dso_report.rml', parser = dealer_sale_order, header = False)