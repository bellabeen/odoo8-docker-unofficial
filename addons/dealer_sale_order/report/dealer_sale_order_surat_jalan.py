...
report_sxw.report_sxw('report.rml.dealer.sale.order.surat.jalan', 'dealer.sale.order', 'addons/dealer_sale_order/report/dealer_sale_order_subsidi_surat_jalan.rml', parser = dealer_sale_order, header = False)