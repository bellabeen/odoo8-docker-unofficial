...
report_sxw.report_sxw('report.rml.dealer.sale.order.bastk', 'dealer.sale.order', 'addons/dealer_sale_order/report/dealer_sale_order_bastk_report.rml', parser = dealer_sale_order, header = False)