...
class teds_so_aksesoris_unit_print_bakso(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(teds_so_aksesoris_unit_print_bakso, self).__init__(cr, uid, name, context=context)
        self.localcontext.update({
            ...
            'total_unit':self._get_total_unit,
    ...
    def _get_total_unit(self,data):
        return data['total_unit']
    def _get_total_fisik(self,data):
        return data['total_fisik']

    
class teds_so_aksesoris_unit_print_bakso_report(osv.AbstractModel):
    _name = 'report.teds_stock_opname_unit.teds_stock_opname_aksesoris_unit_print_bakso'
    _inherit = 'report.abstract_report'
    _template = 'teds_stock_opname_unit.teds_stock_opname_aksesoris_unit_print_bakso'
    _wrapped_report_class = teds_so_aksesoris_unit_print_bakso
