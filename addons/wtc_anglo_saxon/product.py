...
class product_category(osv.osv):
    ...
    _columns = {
        ...
        'property_account_mutation_categ': fields.property(
            type='many2one',
            relation='account.account',
            string="Mutation Account",
            help="This account will be used to value outgoing stock interbranch."),
...
class product_template(osv.osv):
    ...
    _columns = {
        ...
        'property_account_expense': fields.property(
            ...
            string="Expense Account",
            help="This account will be used to value outgoing stock using cost price."),
        'property_account_mutation': fields.property(
            type='many2one',
            relation='account.account',
            string="Mutation Account",
            help="This account will be used to value outgoing stock mutation."),
