...
class teds_so_bpkb_print_bakso(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(teds_so_bpkb_print_bakso, self).__init__(cr, uid, name, context=context)
    ...
    def _get_saldo_ga(self,data):
        return data['saldo_ga']
    ...
    def _get_saldo_leasing(self,data):
        return data['saldo_leasing']
    ...
    def _get_other_bpkb(self,data):
        return data['other_bpkb']
...
class teds_so_bpkb_print_bakso_report(osv.AbstractModel):
    _name = 'report.teds_stock_opname.teds_stock_opname_bpkb_print_bakso'
    _inherit = 'report.abstract_report'
    _template = 'teds_stock_opname.teds_stock_opname_bpkb_print_bakso'
    _wrapped_report_class = teds_so_bpkb_print_bakso
