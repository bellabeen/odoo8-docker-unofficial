...
class wtc_account_invoice_refund(osv.osv_memory):
            ...
            for inv in inv_obj.browse(cr, uid, context.get('active_ids'), context=context):
                ...
                if mode in ('cancel', 'modify'):
                    ...
                    for line in inv.payment_ids :
                        ...
                        credit += line.credit
                    if debit != credit :
                        raise osv.except_osv(('Perhatian !'), ("Tidak bisa cancel, silahkan lakukan pembatalan Pembayaran terlebih dahulu !"))
                    movelines = inv.move_id.line_id + inv.payment_ids
                    to_reconcile_ids = {}
                    ...
                    if mode == 'modify':
                        invoice = inv_obj.read(cr, uid, [inv.id],
                                    ['division','document_date','origin','name', 'type', 'number', 'reference',
