...
from .wtc_report_import_trial_balance import wtc_import_trial_balance_report_print
...
class wtc_import_trial_balance_print_xls(wtc_import_trial_balance_report_print):

    def __init__(self, cr, uid, name, context):
        super(wtc_import_trial_balance_print_xls, self).__init__(
            cr, uid, name, context=context)
        moveline_obj = self.pool.get('account.move.line')
        self.context = context
        wl_overview = moveline_obj._report_xls_import_trial_balance_fields(
            cr, uid, context)
...
class import_trial_balance_report_xls(report_xls):

    def __init__(self, name, table, rml=False,
                 parser=False, header=True, store=False):
        super(import_trial_balance_report_xls, self).__init__(
...
import_trial_balance_report_xls(
    'report.wtc_report_import_trial_balance_xls',
    'account.move.line',
    parser=wtc_import_trial_balance_print_xls)
