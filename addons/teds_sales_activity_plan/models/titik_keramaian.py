...
class TitikKeramaian(models.Model):
    ...
    category = fields.Selection([('Kategori Titik keramaian','Kategori Titik keramaian'),
            ...
            ('Rumah Ibadah','Rumah Ibadah')],'Category'
            )
    jarak = fields.Integer('Jarak (km)')
    waktu = fields.Integer('Waktu (menit)')
    kelurahan_id = fields.Many2one('wtc.kelurahan','Kelurahan')
    dealer_kompetitor = fields.Char('Dealer Kompetitor')
    profil_konsumen = fields.Char('Profil Konsumen')
