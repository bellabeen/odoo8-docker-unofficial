...
class wtc_penerimaan_stnk(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(wtc_penerimaan_stnk, self).__init__(cr, uid, name, context=context)
    ...
    def jumlah_cetakan(self):
        ...
        obj_model_id = obj_model.search(self.cr, self.uid,[ ('model','=','wtc.penerimaan.stnk') ])[0]
...
report_sxw.report_sxw('report.rml.penerimaan.stnk', 'wtc.penerimaan.stnk', 'addons/wtc_proses_stnk/report/wtc_penerimaan_stnk_report.rml', parser = wtc_penerimaan_stnk, header = False)