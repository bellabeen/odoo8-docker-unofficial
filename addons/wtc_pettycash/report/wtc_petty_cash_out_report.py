...
class wtc_pettycash(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(wtc_pettycash, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.rml.wtc.pettycash', 'wtc.pettycash', 'addons/wtc_pettycash/report/wtc_petty_cash_out_report.rml', parser = wtc_pettycash, header = False)