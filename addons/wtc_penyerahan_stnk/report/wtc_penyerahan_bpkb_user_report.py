...
class wtc_penyerahan_bpkb_user(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(wtc_penyerahan_bpkb_user, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.rml.wtc.penyerahan.bpkb.user', 'wtc.penyerahan.bpkb', 'addons/wtc_penyerahan_stnk/report/wtc_penyerahan_bpkb_user_report.rml', parser = wtc_penyerahan_bpkb_user, header = False)