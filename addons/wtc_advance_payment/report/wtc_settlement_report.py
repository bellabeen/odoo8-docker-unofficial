...
# report_sxw.report_sxw('report.rml.settlement', 'wtc.settlement', 'addons/wtc_advance_payment/report/wtc_settlement_report.rml', parser = wtc_settlement, header = False)
class report_advance_payment_draft(osv.AbstractModel):
    _name = 'report.wtc_advance_payment.settlement_draft'
    _inherit = 'report.abstract_report'
    _template = 'wtc_advance_payment.settlement_draft'
