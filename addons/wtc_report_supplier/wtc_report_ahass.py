...
class wtc_report_ahass(osv.osv_memory):
   
    _inherit = "report.supplier"

    wbf = {}

    def _print_excel_report_ahass(self, cr, uid, ids, data, context=None):
        ...
        where = "WHERE s.ahass = true AND " + where_start_date + " AND "+ where_end_date 
        ...
        filename = 'Report Supplier Ahass '+str(date)+'.xlsx'  
