...
class wtc_report_dealer(osv.osv_memory):
   
    _inherit = "report.supplier"

    wbf = {}

    def _print_excel_report_dealer(self, cr, uid, ids, data, context=None):
        ...
        where = "WHERE s.dealer = true AND " + where_start_date + " AND "+ where_end_date 
        ...
        filename = 'Report Supplier Dealer '+str(date)+'.xlsx'  
