...
class wtc_report_forwarder(osv.osv_memory):
   
    _inherit = "report.supplier"

    wbf = {}

    def _print_excel_report_forwarder(self, cr, uid, ids, data, context=None):
        ...
        where = "WHERE s.forwarder = true AND " + where_start_date + " AND "+ where_end_date 
        ...
        filename = 'Report Supplier Forwarder'+str(date)+'.xlsx'  
