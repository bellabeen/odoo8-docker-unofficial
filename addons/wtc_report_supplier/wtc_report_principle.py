...
class wtc_report_principle(osv.osv_memory):
   
    _inherit = "report.supplier"

    wbf = {}

    def _print_excel_report_principle(self, cr, uid, ids, data, context=None):
        ...
        where = "WHERE s.principle = true AND " + where_start_date + " AND "+ where_end_date 
        ...
        filename = 'Report Supplier Principle'+str(date)+'.xlsx'  
