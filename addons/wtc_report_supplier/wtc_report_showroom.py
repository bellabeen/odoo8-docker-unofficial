...
class wtc_report_showroom(osv.osv_memory):
   
    _inherit = "report.supplier"

    wbf = {}

    def _print_excel_report_showroom(self, cr, uid, ids, data, context=None):
        ...
        where = "WHERE s.showroom = true AND " + where_start_date + " AND "+ where_end_date 
        ...
        filename = 'Report Supplier Showroom'+str(date)+'.xlsx'  
