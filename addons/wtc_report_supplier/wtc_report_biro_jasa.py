...
class wtc_report_biro_jasa(osv.osv_memory):
   
    _inherit = "report.supplier"

    wbf = {}

    def _print_excel_report_biro_jasa(self, cr, uid, ids, data, context=None):
        ...
        where = "WHERE s.biro_jasa = true AND " + where_start_date + " AND "+ where_end_date 
        ...
        filename = 'Report Supplier Biro Jasa'+str(date)+'.xlsx'  
