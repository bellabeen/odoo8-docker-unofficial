...
class wtc_work_order(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(wtc_work_order, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.rml.work.order', 'wtc.work.order', 'addons/wtc_work_order/report/wtc_report_work_order.rml', parser = wtc_work_order, header = False)