...
class InsentiveSalesReport(models.TransientModel):
    ...
    def sales_payroll_report(self):
        ...
        query = """
            ...
            GROUP BY dso.user_id,b.id,emp.id,job.id
        ...
        for res in ress:
            ...
            if results.get(res.get('branch_code')):
                ...
                results[res['branch_code']]['reward'] += reward
        ...
        worksheet_summary.set_column('K1:K1', 20)
        ...
        worksheet_detail.set_column('L1:L1', 18)
        worksheet_detail.set_column('M1:M1', 18)
        ...
        worksheet_detail.set_column('S1:S1', 20)
        worksheet_detail.set_column('T1:T1', 20)
        ...
        worksheet_detail.write('K5', 'Total Mediator Cash' , wbf['header'])
        worksheet_detail.write('L5', 'Total Mediator Credit' , wbf['header'])
        worksheet_detail.write('M5', 'Total Unit Mediator' , wbf['header'])
        worksheet_detail.write('N5', 'Total AR Cash' , wbf['header'])
        worksheet_detail.write('O5', 'Total AR Credit' , wbf['header'])
        worksheet_detail.write('P5', 'Total AR' , wbf['header'])
        worksheet_detail.write('Q5', 'Rupiah AR Cash' , wbf['header'])
        worksheet_detail.write('R5', 'Rupiah AR Credit' , wbf['header'])
        worksheet_detail.write('S5', 'Total Rupiah  AR' , wbf['header'])
        worksheet_detail.write('T5', 'Total Insentif' , wbf['header'])
        ...
        for result in results.values():
            ...
            worksheet_summary.write('H%s' % row_sm, result['reward'] , wbf['content_right'])
        ...
        for detail in result_details:
            ...
            worksheet_detail.write('K%s' % row_dt, detail['total_mediator_cash'] , wbf['content_right'])
            worksheet_detail.write('L%s' % row_dt, detail['total_mediator_credit'] , wbf['content_right'])
            worksheet_detail.write('M%s' % row_dt, detail['total_unit_mediator'] , wbf['content_right'])
            worksheet_detail.write('N%s' % row_dt, detail['total_ar_cash'] , wbf['content_right'])
            worksheet_detail.write('O%s' % row_dt, detail['total_ar_credit'] , wbf['content_right'])
            worksheet_detail.write('P%s' % row_dt, detail['total_ar'] , wbf['content_right'])
            worksheet_detail.write('Q%s' % row_dt, detail['rupiah_unit_ar_cash'] , wbf['content_float'])
            worksheet_detail.write('R%s' % row_dt, detail['rupiah_unit_ar_credit'] , wbf['content_float'])
            worksheet_detail.write('S%s' % row_dt, detail['rupiah_total_ar'] , wbf['content_float'])
            worksheet_detail.write('T%s' % row_dt, detail['total_insentif'] , wbf['content_float'])
        ...
        formula_total_mediator_cash = '{=subtotal(9,K%s:K%s)}' % (row_dt1, row_dt-1)
        formula_total_mediator_credit = '{=subtotal(9,L%s:L%s)}' % (row_dt1, row_dt-1)
        formula_total_unit_mediator = '{=subtotal(9,M%s:M%s)}' % (row_dt1, row_dt-1)
        formula_total_ar_cash = '{=subtotal(9,N%s:N%s)}' % (row_dt1, row_dt-1)
        formula_total_ar_credit = '{=subtotal(9,O%s:O%s)}' % (row_dt1, row_dt-1)
        formula_total_ar = '{=subtotal(9,P%s:P%s)}' % (row_dt1, row_dt-1)
        formula_rupiah_unit_ar_cash = '{=subtotal(9,Q%s:Q%s)}' % (row_dt1, row_dt-1)
        formula_rupiah_unit_ar_credit = '{=subtotal(9,R%s:R%s)}' % (row_dt1, row_dt-1)
        formula_rupiah_total_ar = '{=subtotal(9,S%s:S%s)}' % (row_dt1, row_dt-1)
        formula_total_insentif = '{=subtotal(9,T%s:T%s)}' % (row_dt1, row_dt-1)
        ...
        worksheet_detail.write_formula(row_dt-1,10,formula_total_mediator_cash, wbf['total_number_float'], sum_total_mediator_cash)
        worksheet_detail.write_formula(row_dt-1,11,formula_total_mediator_credit, wbf['total_number_float'], sum_total_mediator_credit)
        worksheet_detail.write_formula(row_dt-1,12,formula_total_unit_mediator, wbf['total_number_float'], sum_total_unit_mediator)
        worksheet_detail.write_formula(row_dt-1,13,formula_total_ar_cash, wbf['total_number_float'], sum_total_ar_cash)
        worksheet_detail.write_formula(row_dt-1,14,formula_total_ar_credit, wbf['total_number_float'], sum_total_ar_credit)
        worksheet_detail.write_formula(row_dt-1,15,formula_total_ar, wbf['total_number_float'], sum_total_ar)
        worksheet_detail.write_formula(row_dt-1,16,formula_rupiah_unit_ar_cash, wbf['total_number_float'], sum_rupiah_unit_ar_cash)
        worksheet_detail.write_formula(row_dt-1,17,formula_rupiah_unit_ar_credit, wbf['total_number_float'], sum_rupiah_unit_ar_credit)
        worksheet_detail.write_formula(row_dt-1,18,formula_rupiah_total_ar, wbf['total_number_float'], sum_rupiah_total_ar)
        worksheet_detail.write_formula(row_dt-1,19,formula_total_insentif, wbf['total_number_float'], sum_total_insentif)
